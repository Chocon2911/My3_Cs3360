...
public class ManagerCtrl extends AbstractObjCtrl
{
    ...
    {
        this.managerUI.getPreMainUI().dispose();
        this.managerUI.getMainUI().dispose();
        this.managerUI.getInfoUI().dispose();
        this.managerUI.getJoinShopUI().dispose();
        this.managerUI.getCreateStaffUI().dispose();
        this.managerUI.getDeleteStaffUI().dispose();
        this.managerUI.getAddItemUI().dispose();
        this.managerUI = null;
    }
